---
title: "From Sisyphean Employee to Sisyphean Founder?"
...
```mermaid
xychart-beta
    title "VC Funding Per Capita in SEA, 2024 (USD)"
    x-axis ["Singapore", "Malaysia", "Indonesia", "Vietnam", "Thailand", "Philippines"]
    y-axis "USD" 0 --> 1300
    bar [1250.00, 14.71, 12.86, 12.00, 8.33, 3.68]
```
...
```mermaid
%%{ init: { "theme": "base", "themeVariables": { "primaryColor": "#ffffff", "primaryTextColor": "#000000", "primaryBorderColor": "#000000", "lineColor": "#000000", "secondaryColor": "#ffffff", "tertiaryColor": "#ffffff" }, "themeCSS": "rect { fill: #ffffff !important; stroke: #000000 !important; } .label { color: #000000 !important; } path { stroke: #000000 !important; }" } }%%
graph TD
    A["115,000 IT/CS<br/>Graduates Annually"] --> B["60,000–70,000<br/>Absorbed Domestically"]
    A --> C["45,000–55,000<br/>Not Absorbed"]
    B --> D["~78% → BPO<br/>Cost-Center Roles"]
    B --> E["~12% → Higher-Value<br/>Tech Roles"]
    B --> F["~10% → Other<br/>IT-BPM Niches"]
    C --> G["Emigration"]
    C --> H["Remote Work for<br/>Foreign Employers"]
    C --> I["Freelancing on<br/>Global Platforms"]
    D --> J["Limited Career<br/>Ceiling"]
    J --> G
    E --> K["~0.15–0.19%<br/>Become Founders"]
    style A fill:#1a5276,color:#fff
    style C fill:#922b21,color:#fff
    style G fill:#922b21,color:#fff
    style H fill:#b03a2e,color:#fff
    style K fill:#196f3d,color:#fff
```
